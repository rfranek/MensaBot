...
namespace MensaBotParsing.Mensa
{
    ...
    class CanteenElement
    {
        ...
        public CanteenElement(string page, string name)
        {
            _page = page;
            Name = name;
        }
        ...
        {
            DayElements = ListDayElementOnPage(_page);
        }
        ...
        private List<DayElement> ListDayElementOnPage(String page)
        {
